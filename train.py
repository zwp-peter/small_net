...
def main(args):
    ...
    # model = xception(num_classes=args.num_classes, pretrained=False).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/model-epoch-{}-acc-{}.pth".format(epoch, acc))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="./face_data")
